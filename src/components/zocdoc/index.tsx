...
export const ZocDocURL = "https://www.zocdoc.com/practice/allergy-asthma-and-sinus-centers-3233?lock=true&isNewPatient=false&referrerType=widget";
...
export const ZocDoc = () => {
    ...
    const zocDocRef = useRef<HTMLDivElement>(null);
    ...
    // forward the click to the ZocDoc bubble
    const triggerZocDoc: MouseEventHandler = (event) => {
        const zocdocAnchor = zocDocRef.current?.querySelector("a") as HTMLElement;
        if (!!zocdocAnchor) {
    ...
    return (
        <aside css={stylesZocDoc}>
            ...
            <div ref={zocDocRef} css={css`display: none`}>
                <a href={ZocDocURL}
                   className='zd-plugin' data-type='book-button' data-practice-id='3233'/>
            </div>
        </aside>
    );
}
