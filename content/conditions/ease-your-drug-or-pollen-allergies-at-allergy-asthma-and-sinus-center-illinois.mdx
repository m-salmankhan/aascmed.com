...
- **Sublingual Immunotherapy (SLIT):** SLIT involves drops or tablets taken under the tongue on a daily basis.- **Traditional Immunotherapy (SCIT):** SCIT involves injections given weekly for 8 months, which are then reduced to once a month for 3-5 years. In Rush Immunotherapy, we can deliver 4 months of injections in one day to accelerate reaching the once-a-month injection schedule.- **Intralymphatic Therapy (ULTRA RUSH IT):** ULTRA RUSH IT involves injections given one month apart, for a total of 3 injections, achieving the same results as SCIT in 3-5 years. This is completed in a total 3-month course.- SLIT - drop or tablets talen under tongue on daily basis
